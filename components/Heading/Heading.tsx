...
const headingLevels: HeadingVariants = {
  H1: (props: HeadingProps) => (
    <HeadingBase element="h1" type="xl" {...props} />
  ),
  H2: (props: HeadingProps) => (
    <HeadingBase element="h2" type="lg" {...props} />
  ),
  H3: (props: HeadingProps) => (
    <HeadingBase element="h3" type="md" {...props} />
  ),
  H4: (props: HeadingProps) => (
    <HeadingBase element="h4" type="sm" {...props} />
  ),
}
...
const Heading = Object.assign(HeadingBase, {
  ...
  MarginWhenAdjacent: {
    H1: (props: HeadingProps) => (
      <headingLevels.H1 isMarginWhenAdjacent {...props} />
    ),
    H2: (props: HeadingProps) => (
      <headingLevels.H2 isMarginWhenAdjacent {...props} />
    ),
    H3: (props: HeadingProps) => (
      <headingLevels.H3 isMarginWhenAdjacent {...props} />
    ),
    H4: (props: HeadingProps) => (
      <headingLevels.H4 isMarginWhenAdjacent {...props} />
    ),
  } satisfies HeadingVariants,
})
