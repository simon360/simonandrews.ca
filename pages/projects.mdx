...
## [How to stop email spoofing on your domain](/articles/how-to-set-up-spf-dkim-dmarc)

Just an article, detailing how to limit spoofers' ability to send fake emails on your domain. This information was a nightmare to collate, so I've shared it here, in the hope that it saves _someone_ from going through what I did.
...
export default function Layout({ children }) {
  return <StandardLayout meta={meta}>{children}</StandardLayout>
}
