...
<Paragraph isLead>How to prevent email spoofing on your domain, using an unholy combination of silly standards.</Paragraph>
...
<Paragraph><small>Last updated: <time dateTime="2021-08-17T19:10:00.000+0100">17 August 2021, 7:10 PM BST</time></small></Paragraph>
...
export default function Layout({ children }) {
  return <Article meta={meta}>{children}</Article>
}
